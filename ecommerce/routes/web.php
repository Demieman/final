...
// Route to open the checkout page
Route::get('/checkout', [booking::class, 'opencheckoutpage'])->name('checkout');

// Route to show the shipping and payment screen
Route::get('/shipping-payment', [booking::class, 'shippingPaymentScreen'])->name('shipping.payment');

// Route to handle the order submission
Route::post('/order-proceed', [booking::class, 'orderProceed'])->name('order.proceed');
...
Route::get('/Shop/{purl}', [FrontEndController::class, 'index']);
Route::get('/user/dashboard', 'UserController@index')->middleware('auth');
    ...
    Route::post('order-proceed', [UserController::class, 'orderProceed'])->name('order.proceed');
...
Route::post('/alter-quantity', [CartController::class, 'alter_quantity']);
Route::post('/remove-from-cart', [CartController::class, 'remove']);
Route::post('/clear-cart', [CartController::class, 'clear']);
...
// Profile Routes
Route::get('profile', [UserController::class, 'open_profile'])->name('user.profile');
Route::post('profile/update', [UserController::class, 'update'])->name('user.profile.update');

// Orders
Route::get('orders', [UserController::class, 'open_orders'])->name('user.orders');

// Transactions
Route::get('transactions', [UserController::class, 'open_transactions'])->name('user.transactions');

// Update Password
Route::post('password/update', [UserController::class, 'updatepassword'])->name('user.password.update');

// Send Email
Route::post('send-email', [UserController::class, 'send_email'])->name('send.email');
