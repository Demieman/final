    ...
    <div class="row text-center text-md-left mt-3 pb-3">
      ...
      <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
        ...
        <p>E-commerce, or electronic commerce, refers to the buying and selling of goods and services over the internet.
            It encompasses a wide range of transaction types, including retail sales, wholesale, and auctions, and can
             involve both physical and digital products.</p>
      ...
      <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mt-3">
        ...
        <p>
          <a href="{{url('about')}}" target="_blank">About Me</a>
        </p>
      ...
      <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3">
        ...
        <p>
          <i class="fas fa-home mr-3"></i>  Wollo university, KIOT</p>
        <p>
          <i class="fas fa-envelope mr-3"></i> demelashasires4@gmail.com</p>
        <p>
          <i class="fas fa-phone mr-3"></i> Demelash : +251 924044671</p>
        <p>
          <i class="fas fa-phone mr-3"></i>Demelash : +251 937442129</p>
      </div>
      <!-- Grid column -->
    ...
    <div class="row d-flex align-items-center">
      ...
      <div class="col-md-7 col-lg-8">
        ...
        <p class="text-center text-md-left">© 2024 Copyright:
          ...
          <br>
          <span> Developed by <a href="https://www.rahulvijayam.com" target="_blank" style=" font-family: 'Balsamiq Sans', cursive;"><u>Demelash</u></a> </span>
        </p>
