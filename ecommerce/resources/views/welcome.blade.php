@extends('layout')
@section('title') Ecommerece @endsection
 ...
 <div id="About" class="container-fluid" style="background:white;">
    <br>
      <div class="row ">
        ...
        <img src="{{asset('assets/images/logoo.png')}}" alt="" class="img-fluid" >
        </div>
        <div  align="center" class="col-md-8 wow animated flash slow">
            <h1 class="black-text" style="font-weight:bold;">About E-commerce</h1>
            ...
            <div class="row my-5" style="font-size:30px; font-family: 'Balsamiq Sans', cursive;">
              <div class="col-md-6" >
                    <ul align="left" style="list-style:none;">
                        <li><i class="fab fa-pagelines"></i> E-commerce is easy way to develop</li><br>
                        <li><i class="fab fa-pagelines"></i> social E-commerce</li>
                    </ul>
              </div>
              <div class="col-md-6">
                    <ul align="left" style="list-style:none;">
                    <li><i class="fab fa-pagelines"></i> Customer Engagement</li><br>
              ...
              <div class="col-lg-5 d-flex align-items-stretch">
                <div align="left" class="info">
                  ...
                  <i class="fas fa-envelope"></i>
                    <h4>Email:</h4>
                    <p>demelashasires4@gmail.com</p>
                  </div>

                  <div class="phone">
                  <i class="fas fa-phone"></i>
                    <h4>Call:</h4>
                    <p>Demelash : +251 924044671<br>
Demelash : +251 937442129</p>
                  </div>
